...
const Straypawspage = () => {
  return (
    ...
    <Projectoverview projectName="Stray Paws" projectType="A website commission from an animal rescue" projectImage={strayPaws} projectGithub="" projectWebsite="https://www.straypawsrescue.com/"> 
